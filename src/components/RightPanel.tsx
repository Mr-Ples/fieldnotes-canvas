...
export default function RightPanel() {
  const [tab, setTab] = useState<'annotations' | 'chat'>(() => new URL(window.location.href).searchParams.has('discordConnect') || window.location.hash.startsWith('#discord-message-') ? 'chat' : 'annotations')
